...
Note that the unit tests will fail on this repository, since assignments are not yet implemented.  That's your job :) ;) ;) finally all packages in my docker image?
